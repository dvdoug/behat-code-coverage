                    ...
                    ->children()
                        ...
                        ->arrayNode('crap4j')
                            ->children()
                                ->scalarNode('name')->defaultNull()->end()
                                ->scalarNode('target')->isRequired()->cannotBeEmpty()->end()
                                ->scalarNode('threshold')->defaultValue(30)->end()
                            ->end()
                        ->end()
                        ->arrayNode('html')
                            ->children()
                                ...
                                ->arrayNode('colors')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('successLow')->defaultValue('#d6e6f2')->end()
                                        ->scalarNode('successLowDark')->defaultValue('#1e3550')->end()
                                        ->scalarNode('successMedium')->defaultValue('#b3d1e8')->end()
                                        ->scalarNode('successMediumDark')->defaultValue('#2d4f6e')->end()
                                        ->scalarNode('successHigh')->defaultValue('#8cb4d5')->end()
                                        ->scalarNode('successHighDark')->defaultValue('#2a4a6b')->end()
                                        ->scalarNode('successBar')->defaultValue('#1a73b4')->end()
                                        ->scalarNode('successBarDark')->defaultValue('#1560a0')->end()
                                        ->scalarNode('warning')->defaultValue('#fdf0d5')->end()
                                        ->scalarNode('warningDark')->defaultValue('#3d3010')->end()
                                        ->scalarNode('warningBar')->defaultValue('#e5a100')->end()
                                        ->scalarNode('warningBarDark')->defaultValue('#b88a00')->end()
                                        ->scalarNode('danger')->defaultValue('#fad4c0')->end()
                                        ->scalarNode('dangerDark')->defaultValue('#4a2a10')->end()
                                        ->scalarNode('dangerBar')->defaultValue('#d45500')->end()
                                        ->scalarNode('dangerBarDark')->defaultValue('#b54400')->end()
                                        ->scalarNode('breadcrumbs')->defaultValue('var(--bs-gray-200)')->end()
                                        ->scalarNode('breadcrumbsDark')->defaultValue('var(--bs-gray-800)')->end()
                                    ->end()
                                ->end()
                        ...
                        ->end()
                        ->arrayNode('php')
                            ->setDeprecated('dvdoug/behat-code-coverage', '5.4.2', 'the `php` key is deprecated, it has been removed from php-code-coverage v14. Use `serialized` instead')
                            ->children()
                                ->scalarNode('target')->isRequired()->cannotBeEmpty()->end()
                                ->scalarNode('includeGitInformation')->defaultFalse()->end()
                            ->end()
                        ->end()
                        ->arrayNode('serialized')
                            ->children()
                                ->scalarNode('target')->isRequired()->cannotBeEmpty()->end()
                                ->scalarNode('includeGitInformation')->defaultFalse()->end()
                            ->end()
